							...
							<div class="layout-blog__content">
								...
								<div class="post-01__style-02 md-text-center">
									<div class="post-01__media">
										...
										<div class="carousel__element owl-carousel" data-options="{items: 1, loop: true, nav: true, dots: false, mouseDrag: true}">
								...
								<!-- pagination -->
								<ul class="pagination" style="margin-left: 42%"><a class="pagination__item" href="#">1</a><a class="pagination__item" href="#">2</a><a
